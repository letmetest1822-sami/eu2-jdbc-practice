 ...
 */
    ...
    public void PostNewSpartan(){
        ...
        //verify message is A spartan is Born!
        ...
        assertEquals(phone, 88774455961l);
    }
    ...
    public void PostNewSpartanWithMap(){
        ...
        //we dont assert id bc it is dynamic yet
        int idFromPost= response.path("data.id");

        //END OF POST REQUEST
        //after post the new spartan, we eant to send get request
        ...
        //to see on the console status, headers and the body write .log().all()

    }

    @Test
    public void PostNewSpartan3POJO(){
    ...
    @Test
    public void PostNewSpartanMeta(){
